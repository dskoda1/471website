...
<!-- Figure 13.19 (Example 13.42)
    
    To work correctly, the companion file, bib.xml, must be loaded by an
    XSLT processor, e.g. the one embedded in some recent web servers and
    browsers.  The two files must be in the same directory.
-->
