...
"""
     ...
     This codes illustrates that "self" is just a convention.  
"""
class Tree:

    def __init__(this, label, left=None, right=None):
        this.label = label
        this.left = left
        this.right = right
...
# 1) The __iter__() method traverses itself in inorder.
# 2) Returns a preorder iterator
# 3)   # Returns a postorder iterator
