#!/usr/bin/python
"""
Different implementation styles of factorial.
...
#This works for both Python 2.7 and 3.3
...
def factf (number):
    ...
    This is the imperative style using for loop like the "C" example
    """
    acc = 1
    for i in range (1,number + 1):    # i assumes the values 2 to n
        acc = i * acc
    return acc
