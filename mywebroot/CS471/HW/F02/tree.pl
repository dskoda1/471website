...
% 1) Write a procedure, isBinaryTree(Tree), that succeeds 
     if Tree is a binary tree.
% 2) Write a procedure, isBST(Tree), that succeeds 
     if Tree is a binary search tree.
% 3) sumTree(Tree) that computes the sum of the integer values.
/*********************************************************************/    
