...
# defining functions and calling a function
...
def myPrt(patObj, str) :
    print "in myPrt"
    resultObj = patObj.search(str)
    if resultObj:  
        print " "+ resultObj.group(1)


myPrt(patObj, 'From gjc@inescporto.pt  Mon May  2 03:51:43 2005')   
