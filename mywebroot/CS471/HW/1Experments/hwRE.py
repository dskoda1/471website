...
# Simple print out
print
print 'Example by Eileen Head'  # Can use either ' or " to delimit literal strings
...
# compile a regular expression to use on the data string
patObj = re.compile(patStr)

# One difference between match and search
...
# Instead of compiling the re pattern you can pass it directly to the function
print "selection set"
...
# groups allow a way to captures substrings recognized by RE
...
######################### Selecting text from a file #####################

# Example code for listing all files in current directory
