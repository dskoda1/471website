...
%Do problems 6 and 7 after we cover append in class.
...
% 8) Write a procedure, isBinaryTree(Tree), that succeeds 
%                  if Tree is a binary tree.
% 10) Write a procedure, isBST(Tree), that succeeds 
%                  if Tree is a binary search tree.
% 9) Write a procedure, prodTree(Tree,Prod)that succeeds if 
%                  given a binary Tree with number values
%                  then Prod is the product of all the values.
/*********************************************************************/    
