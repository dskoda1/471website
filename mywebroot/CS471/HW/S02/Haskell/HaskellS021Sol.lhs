...
of 'e' in a string. You can use some pattern matching
...
> countC [] = 0
> countC (c:cs) = if c == 'e' then 1 + countC cs else countC cs 
...
> countE e (c:cs) =  if c == e then 1 + countE e cs else countE e cs 
> countE e [] = 0
