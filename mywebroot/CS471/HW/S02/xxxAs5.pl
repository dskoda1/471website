...
% 3. numberOfatoms( Nestedlst,Num)

% 4.


/* CS471 - Feb 10, 2002 5:20pm */
...
/***********************
 The tree code below is just an example 
 and NOT needed to solve homework!
**********************/
...
/*****************************************************/
% Some test data.  This will help you to test you code. 
% See Below for examples of using this.
