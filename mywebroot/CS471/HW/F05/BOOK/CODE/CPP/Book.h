...
// The preprocess commands are here to avoid redeclaration of class Book. 
#ifndef BOOK
#define BOOK
...
public:
	...
	// "<" compares two books using title then year.
...
class YearThenTitle    
// This is another example of function class (functor) which can be used
...
class JustTitle   
// This is an example of a functor (function object)
...
public:
	...
	// NOTE: The function call operator,(), is overloaded
